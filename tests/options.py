def pytest_addoption(parser):
    group = parser.getgroup('ais-pu-portals')
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='BSMCOMS', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='2St3vs7p', help='Password')
